...
Namespace System.Text
  ...
  Public Class Base32Encoding
    ...
    Public Shared Function LongToBase32String(extendee As Long) As String
      Return Base32Encoding.BytesToBase32String(BitConverter.GetBytes(extendee))
    End Function

    Public Shared Function Base32StringToLong(extendee As String) As Long
      Return BitConverter.ToInt64(Base32Encoding.Base32StringToBytes(extendee), 0)
    End Function

    Public Shared Function Base32StringToBytes(input As String) As Byte()
    ...
    Public Shared Function BytesToBase32String(input As Byte()) As String
