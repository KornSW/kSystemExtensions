...
#If NET5 Then
    ...
    <Extension(), EditorBrowsable(EditorBrowsableState.Advanced)>
    <Obsolete("PLEASE USE System.Xaml.XamlServices (from System.Xaml Package)", True)>
    Public Sub FromXaml(Of T)(ByRef extendee As T, ByVal source As Stream)
      Throw New NotImplementedException("PLEASE USE System.Xaml.XamlServices (from System.Xaml.dll)")
    End Sub
